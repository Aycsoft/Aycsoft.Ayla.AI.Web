...
export interface Attachment { FileId: string; FileName: string; ContentType?: string; FileSize?: number; ContentUrl?: string; DownloadUrl?: string }
export interface Citation { DocumentId?: string; DocumentName?: string; Title?: string; Url?: string; URL?: string; SourceUrl?: string; Uri?: string; Section?: string; Page?: number; Score?: number; FileId?: string; ContentUrl?: string; DownloadUrl?: string }
