/** 媒体空态示例目录：静态素材是创作参考，不代表当前用户生成结果。 */
export type MediaCreationMode = 'image' | 'video'
/** 提示词要求的输入方式；参考图/首尾帧仍由用户另行上传。 */
export type MediaGenerationMode =
  'text-to-image' | 'image-to-image' | 'text-to-video' | 'image-to-video' | 'keyframe-video'

/** 一个可填入创作输入框的示例及其 public/cases 相对素材路径。 */
...
const imageItems: MediaInspirationItem[] = [
  {
    ...
    summary: '材质、光线与商业构图',
    prompt:
      '生成一张 16:9 商业产品图：白色陶瓷香薰瓶与黑色藤条置于暖灰色摄影棚中，柔和侧逆光突出陶瓷质感，主体完整，画面简洁，无品牌、无文字。',
  ...
  },
  {
    ...
    summary: '人物、环境与电影氛围',
    prompt:
      '生成一张 16:9 生活方式摄影：一位穿白色长裙的年轻东亚女性行走在日落时分的薰衣草田，微风吹动衣摆，暖色逆光，电影感，人物自然，无文字。',
  ...
  },
  {
    ...
    summary: '产品悬浮与科技光效',
    prompt:
      '生成一张 16:9 科技运动鞋产品海报：浅灰色未来感跑鞋悬浮于深蓝背景，蓝紫色光轨环绕，轮廓光清晰，构图高级，为标题预留安全区域，不生成文字。',
  ...
  },
  {
    ...
    prompt:
      '请先上传一张产品参考图。以附件中的产品为唯一主体参考，严格保留产品造型、比例、颜色与材质，把背景更换为暖色现代客厅窗边场景，加入柔和晨光和自然景深，不增加文字或其他产品。',
...
const videoItems: MediaInspirationItem[] = [
  {
    ...
    summary: '稳定镜头与材质表现',
    prompt:
      '生成一段 5 秒 16:9 产品展示视频：白色陶瓷香薰瓶在浅灰背景上缓慢旋转，镜头平稳环绕，棚拍柔光突出陶瓷材质，背景干净，无文字。',
  ...
  },
  {
    ...
    summary: '保持主体，补充自然运动',
    prompt:
      '请先上传一张参考图片。基于附件画面生成 5 秒 16:9 视频，严格保持主体外观和场景结构，仅加入轻微自然运动、柔和光影变化与缓慢推镜，首帧与参考图一致，避免主体变形和新增文字。',
  ...
  },
  {
    ...
    summary: '光线变化与细腻推镜',
    prompt:
      '生成一段 5 秒 16:9 电影感短片：清晨阳光缓慢扫过整洁办公桌、笔记本电脑与绿植，镜头轻微向前推进，光影自然变化，画面稳定，无人物、无文字。',
  ...
  },
  {
    ...
    summary: '首尾一致与连续转场',
    prompt:
      '请上传首帧和尾帧两张参考图。生成一段 5 秒 16:9 连贯转场视频：从首帧场景平滑过渡到尾帧场景，主体身份、比例和纹理保持一致，运动路径自然，镜头稳定，不新增文字。',
